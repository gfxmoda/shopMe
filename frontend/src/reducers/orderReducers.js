...
export const orderListAllOrdersReducer = (state = { orders: [] }, action) => {
  switch (action.type) {
    case ORDER_LIST_ALL_ORDERS_REQUEST:
      return {
        loading: true,
      };
    case ORDER_LIST_ALL_ORDERS_SUCCESS:
      return {
        loading: false,
        orders: action.payload,
      };
    case ORDER_LIST_ALL_ORDERS_FAIL:
      return {
        loading: false,
        error: action.payload,
      };
